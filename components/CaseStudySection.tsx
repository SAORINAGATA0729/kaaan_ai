...
export function CaseStudySection() {
  ...
  const caseStudies = [
    ...
    },
    {
      ...
      problems: [
        "増え続けるチャネルと業務で、全てが中途半端になってしまう（激戦領域への後発参入）",
        "短期間で大量のコンテンツが必要だがリソースが不足",
        "品質のばらつきと管理コストの増大（法律的なリスク管理も含めた品質管理体制が必要）",
        "量を増やすと品質が落ち、品質にこだわると数が作れない"
      ],
      results: [
        "立ち上げ1年以内に100万MAUを達成",
        "月間100〜200本の安定的な制作体制を構築",
        "分業体制と多段階チェックプロセスにより、品質と生産性を両立",
        "トレンドとエリア特化を掛け合わせたコンテンツSEO施策により、継続的な流入の仕組みを構築",
        "各メンバーの専門性とモチベーションを最大限に引き出す運用体制を整備"
      ]
    }
  ];
