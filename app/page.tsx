        ...
        <div className="container mx-auto px-6 md:px-8 max-w-[900px]">
          ...
          <div className="text-lg md:text-xl text-[#1a1a1a] leading-relaxed font-medium text-center">
            ...
            <div className="space-y-3 mb-12 text-gray-500">
              <p className="whitespace-nowrap">「議事録の要約は、一瞬で終わるようになった。」</p>
              <p className="whitespace-nowrap">「資料の骨子作成も、壁打ちも、AIがやってくれる。」</p>
            ...
            {[
              {
                ...
                a: "問題ありません。KAAANが提供するのは「ツール導入」ではなく、「事業成果を実現するための仕組み」です。目的達成の手段としてAIをどう活用すべきかを設計し、実務で使いこなせるようになるまで伴走します。"
              },
              {
                q: "どのようなAIツールを使用しますか？",
                a: "特定のツールに縛られません。プロジェクトの要件に応じて最適なものを選定しますが、KAAANでは主に「Cursor」などのAIエディタや、Claude、Geminiなどの最新モデルを活用し、業務プロセス自体を変革する環境を構築します。"
              },
              {
                q: "情報セキュリティや機密保持は大丈夫ですか？",
                a: "セキュリティは重要事項として認識しております。入力データのオプトアウト設定など基本的な対策は行いますが、社内規定に準拠する必要がある場合は貴社の情報システム部門と連携して進めます。高度な対策が必要な場合は、専門パートナーのご紹介も可能です。"
              },
              {
                q: "どのくらいの期間で成果が出ますか？",
                a: "企業の状況によりますが、構築から1ヶ月目で初稿のアウトプットを開始し、半年から1年で自走体制の確立を目指すのが一般的です。"
              },
              {
